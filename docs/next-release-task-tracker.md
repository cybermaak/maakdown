...
| P19 | Done | Reader feedback polish | macOS check/unit/build/UAT validation passed; Windows/Linux release validation pending |
...
| P19.5 | Done | Add Mermaid source toggle | Frontend | P10.7/P4.4 | Mermaid blocks can switch between rendered diagram and raw fenced source in place; inspect still opens the rendered diagram and print stays rendered | Passed: UAT-05 Mermaid source toggle and diagram restore | Pending: CI/UAT before release | Pending: CI/UAT before release |
