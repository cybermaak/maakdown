...
| P10.8 | In Progress | Add manual reload and external-change status | Full stack | P9.3 | toolbar/tab states expose watching, changed, reload progress, and recoverable errors | watcher integration tests |
...
| P10.13 | In Progress | Add unified Settings surface through the palette | Frontend | P10.5/P9.4 | theme, metadata, reader, panel, and dev/evaluation settings have one persistent home; Shiki remains dev-only | persistence, keyboard, and visual tests |
...
| P11.3 | In Progress | Add responsive narrow-window drawers | Frontend | P11.2 | metadata collapses first; remaining panels become accessible drawers | viewport matrix screenshots |
...
| P11.7 | In Progress | Refine document element presentation | Frontend | P8/P10.0/P11.1 | ink headings with hover anchors, capped prose plus wide diagrams/tables/code, tasks, callouts, footnotes, assets, and wikilinks match approved treatments in both themes | fixture visual regression |
