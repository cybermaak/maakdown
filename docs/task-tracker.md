...
| P10.16 | In Progress | Preserve full-document range during print preparation | Frontend | P10.6/P5.2 | asynchronous block measurements cannot restore virtualization before the system print call; the complete document is mounted and enhanced for the print snapshot | UAT-06 locally; cross-platform `ci/sandbox` verification pending |
